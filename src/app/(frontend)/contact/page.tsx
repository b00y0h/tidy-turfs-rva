      ...
      {options.map((opt) => (
        ...
        >
          <input
            ...
            className="w-4 h-4 text-brand focus:ring-green-500 shrink-0"
          />
          {opt}
        </label>
      ))}
      ...
      {options.map((opt) => (
        ...
        >
          <input
            ...
            onChange={() => toggle(opt)}
            className="w-4 h-4 text-brand focus:ring-green-500 rounded shrink-0"
          />
          {opt}
        </label>
      ))}
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
        ...
        <a
          ...
          className="text-brand text-sm hover:text-green-800 transition-colors inline-block"
        >
          ...
          return (
            <div key={i} className="flex items-center flex-1 last:flex-none">
              <div className="flex items-center gap-2 shrink-0">
                ...
                <span
                  className={`text-xs font-medium hidden sm:block ${active || done ? "text-green-700" : "text-gray-400"}`}
                >
                  {s.label}
                </span>
              </div>
              {i < STEPS.length - 1 && (
                <div
                  className={`flex-1 h-0.5 mx-2 ${done ? "bg-green-600" : "bg-gray-200"}`}
                />
              )}
            </div>
          );
      ...
      {step === 1 && (
        <div className="space-y-5">
          ...
          <button
            type="button"
            onClick={next}
            className="w-full bg-brand text-white py-4 rounded-lg font-bold text-lg hover:bg-brand-hover transition"
          >
            Next →
          </button>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <RadioGroup
              ...
              options={[
                ...
                "Large - 5,000 to 10,000 sq ft",
                "Extra Large - over 10,000 sq ft",
                "Not Sure",
              ]}
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="button"
              onClick={next}
              className="flex-[2] bg-brand text-white py-4 rounded-lg font-bold hover:bg-brand-hover transition"
            >
              Next →
            </button>
          </div>
            ...
            <div className="mt-2">
              <label className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-green-300 cursor-pointer text-sm text-gray-700">
                <input
                  ...
                  onChange={(e) =>
                    set("serviceOther", e.target.checked ? " " : "")
                  }
                  className="w-4 h-4 text-brand rounded shrink-0"
                />
                Other
              </label>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <input
                  ...
                  checked={
                    ...
                    (![
                      ...
                      "Yard Sign",
                      "Nextdoor",
                    ].includes(formData.hearAboutUs) &&
                      formData.hearAboutUs === "Other")
                  }
                  onChange={() => {
                    set("hearAboutUs", "Other");
                    set("hearAboutUsOther", " ");
                  }}
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              className="flex-[2] bg-brand text-white py-4 rounded-lg font-bold text-lg hover:bg-brand-hover transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <section className="hero-bg text-white py-16">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100">
            Thank you for your interest in Tidy Turfs! Please fill out the form
            below and I&apos;ll get back to you within 24 hours with a
            personalized quote.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Texting is the fastest way to reach me. I usually reply within
                  minutes!
                </p>
                <a
                  href="sms:8046789158?body=Hi!%20I%27d%20like%20a%20quote%20for%20lawn%20care%20services."
                  className="block bg-green-50 hover:bg-green-100 transition-colors rounded-lg p-4 text-center"
                >
                  <p className="text-sm text-brand mb-1">Text me anytime:</p>
